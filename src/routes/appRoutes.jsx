...
import { UserLogin, HomePage, UserRegister, CompanyRegister, MachineRegister, UserList, CompanyList, MachineList } from "../components/components"
...
const RoutesOfApp = () => (
    <Routes>
        ...
        <Route exact path="/user/list/:comanyId" element={<UserList/>}/>
        ...
        <Route exact path="/machine/list/:comanyId" element={<MachineList/>}/>
